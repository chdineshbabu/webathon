...
function Cycling() {
  ...
  return (
    <a href="#" className="flex flex-col mb-10 items-center bg-white border border-gray-200 rounded-lg shadow-md md:flex-row md:max-w-md hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
